...
import {
  BarChart2, CheckCircle, Clock, Zap, TrendingUp, Activity,
...
export function GoogleAdsPage() {
  ...
  const all      = (data?.sessions ?? []).filter(s => s.platform === 'google_ads')
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-0.5">Campanhas Search, Display e Performance Max</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Sessões"       value={all.length}      icon={Activity}    color="bg-blue-50 text-blue-500" />
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          <h2 className="font-semibold text-gray-900">Histórico Google Ads</h2>
